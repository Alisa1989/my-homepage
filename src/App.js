...
function App () {
    return(
      <div className="App" style={{backgroundImage: `url("https://images2.alphacoders.com/166/thumb-1920-166600.jpg")`, backgroundSize: 'cover', height: '100%', backgroundPosition:'center', backgroundAttachment:'fixed'}}>
